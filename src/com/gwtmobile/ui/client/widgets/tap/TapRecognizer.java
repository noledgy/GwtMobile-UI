...
//	@Override
	public void onTouchStart(DragEvent event) {
		touchCanceled = false;
		hasMoved = false;
		...
		start_x = event.getNativeEvent().getTouches().get(0).getPageX();
		start_y = event.getNativeEvent().getTouches().get(0).getPageY();
	}

//	@Override
	public void onTouchMove(DragEvent event) {
...
//	@Override
	public void onTouchEnd(DragEvent event) {
...
//  @Override
  public void onTouchCancel(DragEvent event) {
    touchCanceled = true;
  }
